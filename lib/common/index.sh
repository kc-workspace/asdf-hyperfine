...
KC_ASDF_NAME="asdf-hyperfine"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-hyperfine"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="hyperfine"
KC_ASDF_APP_WEBS="https://github.com/sharkdp/hyperfine"
KC_ASDF_APP_DESC="A command-line benchmarking tool"
KC_ASDF_APP_REPO="https://github.com/sharkdp/hyperfine"
